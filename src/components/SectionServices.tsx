...
import CardIcons from "@/assets/icon-card.svg";
...
export function SectionServices() {
  return (
    <section className="w-full h-[965px]">
      <Container>
        <div className="flex-1 max-w-[594px] pt-32">
          <span className="block text-primary-orange text-sm font-bold uppercase mb-9 ">
            serviços exclusivos
          </span>
          <h2 className="text-primary-gray text-[56px] font-bold leading-tight mb-6">
            Gerencie suas finanças sem sair de casa
          </h2>
          <p className="text-lg max-w-[554px] mb-16 text-secondary-gray">
            Veja como você pode cuidar das suas finanças pelo app Itaú de forma
          ...
          <ul className="flex flex-col items-start gap-9">
            ...
            <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
              <div className="w-7 h-7 flex items-center justify-center">
                <Image src={SoluctionsIcon} alt="SolutionsIcon" />
              </div>
              <p className="flex-1 text-txt-gray pr-2">
                Soluções de empréstimos e renegociação para organizar suas finanças
              </p>
            </li>

            <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
              <div className="w-7 h-7 flex items-center justify-center">
                <Image src={OptionsIcons} alt="OptionsIcon" />
              </div>
              <p className="flex-1 text-txt-gray pr-2">
                Diversas opções de investimentos, de acordo com o seu perfil de investidos
              </p>
            </li>

            <li className="flex items-center gap-9 ">
              <div className="w-7 h-7 flex items-center justify-center">
                <Image src={CardIcons} alt="CardIcon" />
              </div>
              <p className="flex-1 text-txt-gray pr-2">
      ...
      <div className="absolute  top-[81%] right-0 flex items-center w-[32%] h-full bg-gray-phone  ">
